                                ...
                                <div className="grid grid-cols-1 gap-y-2 md:grid-cols-[minmax(0,16rem)_minmax(0,16rem)] md:justify-start md:gap-x-2">
                                    ...
                                    {shouldShow('userMessageRendering') && (
                                        <section className="p-2">
                                            ...
                                            <div role="radiogroup" aria-label={t('User message rendering mode')} className="mt-0.5 space-y-0">
                                    ...
                                    {shouldShow('mermaidRendering') && (
                                        <section className="p-2">
                                            ...
                                            <div role="radiogroup" aria-label={t('Mermaid rendering mode')} className="mt-0.5 space-y-0">
                                    ...
                                    {shouldShow('diffLayout') && !isVSCode && (
                                        <section className="p-2">
                                            ...
                                            <div role="radiogroup" aria-label={t('Diff layout')} className="mt-0.5 space-y-0">
                                    ...
                                    {shouldShow('diffLayout') && !isVSCode && (
                                        <section className="p-2">
                                            ...
                                            <div role="radiogroup" aria-label={t('Diff view mode')} className="mt-0.5 space-y-0">
