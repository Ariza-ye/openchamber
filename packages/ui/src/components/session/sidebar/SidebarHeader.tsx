                  ...
                  <>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        ...
                        <TooltipContent side="bottom" sideOffset={4}><p>{t('New worktree')}</p></TooltipContent>
                    </Tooltip>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button
                        ...
                        className={headerActionButtonClass}
                        aria-label={t('Project notes and todos')}
                      >
                  ...
                  <div className="mb-1 flex items-center justify-between px-0.5 typography-micro text-muted-foreground/80">
                    {hasSessionSearchQuery ? (
                        ...
                        {searchMatchCount === 1
                            ...
                            : t('{count} matches', {count: searchMatchCount})}
                      </span>
                    ) : <span />}
